        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Ever1ck/SysEvents.git'
                }
            }
        }
        stage('Build') {
