        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Ever1ck/SysEvents.git'
                }
            }
        }
        stage('Build') {
